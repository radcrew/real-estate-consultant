...
- [x] Operator: set Vercel env on MCP project (Production / Preview / Development):
  - `BACKEND_API_URL=https://real-estate-consultant-be.vercel.app`
  - `HTTP_TIMEOUT_SECONDS=55`
  - `LOG_LEVEL=INFO`
  - `RATE_LIMIT_PER_MINUTE=60`
- [ ] Operator: enable Fluid Compute in the Vercel project dashboard (if not already on by default)
