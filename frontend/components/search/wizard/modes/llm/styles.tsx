export const styles = {
  ...
  chatColumn:
    "flex h-full min-h-0 min-w-0 flex-col rounded-xl border border-border/70 bg-background/95 shadow-[0_20px_70px_-45px_rgba(15,23,42,0.55)]",
  ...
  textarea: [
    "min-h-0 flex-1 resize-none rounded-lg border border-border/80 bg-background px-3 py-2.5 text-sm leading-normal",
