 ...
 * (`ring-opacity-*` -> `/opacity` modifier; `primary-6000` typo -> `primary-600`).
 * Looks best with the @tailwindcss/forms plugin (see note in globals.css todo).
 */
