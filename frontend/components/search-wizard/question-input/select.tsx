...
const CARD_CLASSNAME =
  "group relative grid min-h-32 grid-rows-[auto_auto_1fr] items-start justify-items-center overflow-hidden border px-4 py-5 text-center transition-all duration-200";
...
const ICON_WRAP_CLASSNAME =
  "mb-3 inline-flex size-11 items-center justify-center rounded-xl border transition-colors";
...
const LABEL_CLASSNAME = "text-lg font-semibold tracking-tight text-slate-950";
const HINT_CLASSNAME = "mt-2 text-xs leading-5 text-slate-500 sm:text-sm";
